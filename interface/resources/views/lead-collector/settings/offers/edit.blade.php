        ...
        >
            ...
            <div class="mt-6 container mx-auto shadow-md px-4 py-2 bg-gray-50">
                ...
                <div class="flex justify-center mt-4 md:justify-start md:ml-3.5">
                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-bold px-3 py-1 ml-0 mx-2 my-1 border-b-4 border-green-500 hover:border-green-400 rounded-md"
                    >
                        Edit
                    </button>
                    <a href="{{ route('offers.store', ['page' => $_GET['page'] ?? '1']) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold px-3 py-1 mx-2 my-1 border-b-4 border-yellow-500 hover:border-yellow-500 rounded">
                        Cancel
                    </a>
                </div>
            </div>
